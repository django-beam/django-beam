 ...
 *
 * Issues:
 * [ ] some classes are not configurable
 * [ ] assumptions about the structure of classes
 */
...
(function($){
  ...
  DjangoInline.prototype = {
    ...
    addForm: function(emptyFormSelector) {
      ...
      var newitem = $(newhtml).removeClass("empty-form").removeClass("d-none").attr("id", item_id);
